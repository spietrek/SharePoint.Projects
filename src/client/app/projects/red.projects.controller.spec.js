/* jshint -W117, -W030 */
describe('RedProjectsController', function () {
    var controller;
    var projects = mockData.getMockRedProjects();
    ...
    describe('Projects controller', function () {
        ...
        describe('after activate', function () {
            it('should have title of Red Projects', function () {
                expect(controller.title).to.equal('Red Projects');
            });
