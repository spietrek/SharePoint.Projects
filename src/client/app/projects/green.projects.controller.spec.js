/* jshint -W117, -W030 */
describe('GreenProjectsController', function () {
    var controller;
    var projects = mockData.getMockGreenProjects();
    ...
    beforeEach(function () {
        sinon.stub(dataService, 'getGreenProjects').returns($q.when(projects));
        controller = $controller('GreenProjectsController');
        $rootScope.$apply();
    });
    ...
    describe('Projects controller', function () {
        ...
        describe('after activate', function () {
            it('should have title of Green Projects', function () {
                expect(controller.title).to.equal('Green Projects');
            });
            ...
            it('should have projects count of 1', function () {
                expect(controller.resource.rows).to.have.length(1);
            });
